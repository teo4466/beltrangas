...
<script>
  let url='http://127.0.0.1:8000/clientes/Clientes/'
  ...
  export default {
    ...
    methods: {
      ...
      editItem (item) {
          ...
          let path=`http://127.0.0.1:8000/clientes/Clientes/${item.id}/`
      ...
      deleteItemConfirm () {
         let path=`http://127.0.0.1:8000/clientes/Clientes/${this.editedItem.id}/`
      ...
      save () {
        ...
        if (this.editedIndex > -1) {
          ...
          axios.put(path, this.editedItem ).then((response)=>{
            ...
            let path='http://127.0.0.1:8000/clientes/Clientes/'
